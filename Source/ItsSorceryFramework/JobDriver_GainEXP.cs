...
namespace ItsSorceryFramework
{
    public class JobDriver_GainEXP: JobDriver_Reload
    {
		...
		protected override IEnumerable<Toil> MakeNewToils()
		{
			...
			// dev mode message
			if (Prefs.DevMode && ItsSorceryUtility.settings.ShowItsSorceryDebug) Log.Message($"[It's Sorcery!] Job {job.GetUniqueLoadID()}: schema {schema.def.LabelCap}, item count {count}");
