...
namespace ItsSorceryFramework
{
    public class EnergyTrackerComp_OnDamaged : EnergyTrackerComp_DamageBase
    {
        ...
        public override float CompDrawGUI(Rect rect)
        {
            ...
            Widgets.LabelCacheHeight(ref rect, "ISF_EnergyTrackerCompOnDamagedLabel".Translate(damageDefs).Colorize(ColoredText.TipSectionTitleColor), true, false);
            rect.yMin += rect.height;
            Widgets.LabelCacheHeight(ref rect, "ISF_EnergyTrackerCompOnDamagedDesc".Translate(energyLabel.Named("ENERGY"), ScalingStatDef.label.Named("STAT"), energyFactorString.Named("FACTOR")));
            rect.yMin += rect.height;
